...
protected:
  ...
  void QuaternionControlPoint(Quaternion<double> &q0, Quaternion<double> &q1, Quaternion<double> &q2, Quaternion<double> &q3, Quaternion<double> &an, Quaternion<double> &bn, bool firstKF, bool lastKF);
